...
#to avoid doinf the preprocessing steps again
try:
...
def get_response(msg):
    results = model.predict([bag_of_words(msg, words)]) #give all the words with the input words and returns probabilities of each labels
